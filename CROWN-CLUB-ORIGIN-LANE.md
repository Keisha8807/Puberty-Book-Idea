...
## 2. THE BIG DISCOVERY: THE TWO STORIES RUN PARALLEL 🚆🚆
...
```
SEPTEMBER ─────────────────────────────────────── JUNE
MIA'S WORLD (5th grade):                THE READER'S VIEW
...
**The talent show is the SAME event seen twice** — once from the crowd (Mia's S2 finale), once from the stage (Series B10). We already wrote the Handshake there. Now the club origin gets the same treatment: **outside view in the primer, inside story in the series.**

---

## 3. WHAT MIA'S BOOKS GET (the mystery cameos — no exposition)

Mia doesn't explain the club. She *notices* it, wrong, and it's hilarious:
...
- A back-room meeting location is suddenly OFF LIMITS. Whether it remains inside La Bodega de Luz—and who controls access—is pending story rework; do not attribute it to Uncle Mo.
...
**The 5th-grade reader feels exactly what Mia feels:** there's a door, and they're not old enough yet.

---

## 4. THE READER FUNNEL, MADE INTO STORY
...
1. **The club origin = Series Book 1, untouchable.** No primer content explains, previews, or spoils it.
2. **Mia's education lane ≠ the club lane.** Mia learns through family + friends + school (Mema, Ms. Vitality, Jada & Emma). The club is Solani's learning vehicle. Clean division, no overlap.
3. **The primer's job for the club:** build desire. Three or four mystery cameos across Season 2, max.
4. **The handshake's true meaning:** the reader graduates from outside to inside.

## 6. ONE CANON QUESTION TO RESOLVE LATER (with the B10 blueprint)

**Is the club still secret when the June talent show happens?**
- Option A: still secret → the performance is risky and defiant, and Mia watching from the crowd *knows* she's watching something hidden. The handshake gets extra electricity.
- Option B: already public by June → the show is their celebration, and Mia's S2 saw the secret *become* the legend.
- (Option C: the talent show IS their public debut — the club steps into the light the same night the reader is handed over. 🤯)

This is a B10 decision — flag it, don't decide it yet.

---

*Saved. The origin belongs to Solani. Mia guards the door. The reader walks through it. 💜*
