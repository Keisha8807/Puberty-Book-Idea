# 🎭 MIA'S WORLD — CHARACTER BIBLE & INTRO DECK

> The full cast of **Mia's Puberty Primer** (Seasons 1–2), each with their own voice, look, and "hello world" intro line.
> Double duty: writing reference + marketing (each intro = a social card / clip line / TPT character card).
...
- **Intro line:** *"I'm Solani. I'm funny. That's the whole brand. (No, you may not see the notebook.)"*
...
### 🎭 JADA — *the drama department*
- **10 · 5th grade · confident chaos agent**
- **Signature look:** statement earrings, color-block outfits, expressive hands mid-gesture
- **Personality:** loud, loyal, turns everything into a production
- **Catchphrase:** *"BRING ON THE DRAMA!"*
- **Myth Machine role:** the wild theorist — always 60% alien-related, 10% accidentally right
- **Intro line:** *"Jada. Future actress, current professional best friend. What's the scene?"*
...
- **Intro line:** *"I'm Emma. I draw the evidence. Jada says 'aliens'; I say 'let's check the facts first.'"*
...
## THE DOOR (never opened in Mia's books)
Solani's "study group" — glimpsed only from outside: a clipboard girl, a unicorn-backpack girl, a girl who draws and never talks. No names in the primer. The reader graduates to the series to meet them. (That's the funnel, dressed as mystery. 🚪)
